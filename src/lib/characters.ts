...
export const shapes: ShapeCharacter[] = [
    ...
    { name: 'Cat', path: 'M250,100 a100,100 0 1,1 0,0.1 M180,100 l-30,-50 M320,100 l30,-50 M250,200 a80,150 0 1,1 0,0.1 M150,250 a100,50 0 1,1 200,0', viewBox: '50 0 400 500' },
