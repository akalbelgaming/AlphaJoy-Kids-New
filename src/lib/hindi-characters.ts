...
export const hindiTransliteratedCharacters: HindiTransliteratedCharacter[] = [
  ...
  { display: 'ri = ऋ', pronunciation: 'ri', hindi: 'ऋ' },
  { display: 'e = ए', pronunciation: 'e', hindi: 'ए' },
  { display: 'ai = ऐ', pronunciation: 'ai', hindi: 'ऐ' },
  { display: 'o = ओ', pronunciation: 'o', hindi: 'ओ' },
  { display: 'au = औ', pronunciation: 'au', hindi: 'औ' },
  { display: 'an = अं', pronunciation: 'an', hindi: 'अं' },
  { display: 'ah = अः', pronunciation: 'ah', hindi: 'अः' },
  { display: 'k = क', pronunciation: 'k', hindi: 'क' },
  { display: 'kh = ख', pronunciation: 'kh', hindi: 'ख' },
  { display: 'g = ग', pronunciation: 'g', hindi: 'ग' },
  { display: 'gh = घ', pronunciation: 'gh', hindi: 'घ' },
  { display: 'ch = च', pronunciation: 'ch', hindi: 'च' },
  { display: 'chh = छ', pronunciation: 'chh', hindi: 'छ' },
  { display: 'j = ज', pronunciation: 'j', hindi: 'ज' },
  { display: 'jh = झ', pronunciation: 'jh', hindi: 'झ' },
  { display: 't = ट', pronunciation: 't', hindi: 'ट' },
  { display: 'th = ठ', pronunciation: 'th', hindi: 'ठ' },
  { display: 'd = ड', pronunciation: 'd', hindi: 'ड' },
  { display: 'dh = ढ', pronunciation: 'dh', hindi: 'ढ' },
  { display: 't = त', pronunciation: 't', hindi: 'त' },
  { display: 'th = थ', pronunciation: 'th', hindi: 'थ' },
  { display: 'd = द', pronunciation: 'd', hindi: 'द' },
  { display: 'dh = ध', pronunciation: 'dh', hindi: 'ध' },
  { display: 'n = न', pronunciation: 'n', hindi: 'न' },
  { display: 'p = प', pronunciation: 'p', hindi: 'प' },
  { display: 'ph = फ', pronunciation: 'ph', hindi: 'फ' },
  { display: 'b = ब', pronunciation: 'b', hindi: 'ब' },
  { display: 'bh = भ', pronunciation: 'bh', hindi: 'भ' },
  { display: 'm = म', pronunciation: 'm', hindi: 'म' },
  { display: 'y = य', pronunciation: 'y', hindi: 'य' },
  { display: 'r = र', pronunciation: 'r', hindi: 'र' },
  { display: 'l = ल', pronunciation: 'l', hindi: 'ल' },
  { display: 'v = व', pronunciation: 'v', hindi: 'व' },
  { display: 'sh = श', pronunciation: 'sh', hindi: 'श' },
  { display: 'sh = ष', pronunciation: 'sh', hindi: 'ष' },
  { display: 's = स', pronunciation: 's', hindi: 'स' },
  { display: 'h = ह', pronunciation: 'h', hindi: 'ह' },
  { display: 'ksh = क्ष', pronunciation: 'ksh', hindi: 'क्ष' },
  { display: 'tr = त्र', pronunciation: 'tr', hindi: 'त्र' },
  { display: 'gy = ज्ञ', pronunciation: 'gy', hindi: 'ज्ञ' },
];
