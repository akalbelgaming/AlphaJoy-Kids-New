...
export const hindiTransliteratedCharacters: HindiTransliteratedCharacter[] = [
  ...
  { display: 'i = इ', pronunciation: 'i', hindi: 'harsie' },
  { display: 'ee = ई', pronunciation: 'double ee', hindi: 'dirghae' },
  { display: 'u = उ', pronunciation: 'you', hindi: 'harsu' },
  { display: 'oo = ऊ', pronunciation: 'double o', hindi: 'durghu' },
  ...
  { display: 'dh = ध', pronunciation: 'dee aitch', hindi: 'ध' },
  { display: 'n = न', pronunciation: 'an', hindi: 'न' },
  ...
  { display: 'sh = श', pronunciation: 's h', hindi: 'taalab sha' },
  { display: 'sh = ष', pronunciation: 's h', hindi: 'moordhanya sha' },
  { display: 's = स', pronunciation: 's', hindi: 'dant sa' },
