        ...
        <section className="py-12 md:py-24 px-4">
            <div className="container mx-auto text-center">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4">
                  <div className="rounded-lg overflow-hidden shadow-lg"><Image src="/screenshot-1.png" width="300" height="500" alt="App Screenshot 1" className="w-full h-auto" /></div>
                  <div className="rounded-lg overflow-hidden shadow-lg"><Image src="/screenshot-2.png" width="300" height="500" alt="App Screenshot 2" className="w-full h-auto" /></div>
                  <div className="rounded-lg overflow-hidden shadow-lg"><Image src="/screenshot-3.png" width="300" height="500" alt="App Screenshot 3" className="w-full h-auto" /></div>
                  <div className="rounded-lg overflow-hidden shadow-lg"><Image src="/screenshot-4.png" width="300" height="500" alt="App Screenshot 4" className="w-full h-auto" /></div>
              </div>
            </div>
        </section>
